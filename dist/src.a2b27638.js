...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"node_modules/pretty-print-json/dist/pretty-print-json.js":[function(require,module,exports) {
"use strict";
...
var getData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var requestLink, _yield$axios$get, data, launch_yearData, filterCustomer, sortData;

    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            requestLink = "https://api.spacexdata.com/v3/launches/past";
            _context.next = 3;
            return _axios.default.get(requestLink);

          case 3:
            _yield$axios$get = _context.sent;
            data = _yield$axios$get.data;
            launch_yearData = data.filter(function (_ref2) {
              var launch_year = _ref2.launch_year;
              return launch_year === "2018";
            });
            filterCustomer = launch_yearData.filter(function (_ref3) {
              var payloads = _ref3.rocket.second_stage.payloads;
              return payloads.some(function (item) {
                return item.customers.some(function (customer) {
                  return customer === "NASA" || customer === "NASA (CRS)";
                });
              });
            });
            sortData = filterCustomer.sort(function (a, b) {
              return b.launch_date_utc.localeCompare(a.launch_date_utc);
            }).map(function (_ref4) {
              var payloads = _ref4.rocket.second_stage.payloads,
                  flight_number = _ref4.flight_number,
                  mission_name = _ref4.mission_name;
              return {
            ...
            return _context.abrupt("return", sortData);
...
var render = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(data) {
    var prepareData, elem;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            prepareData = _context2.t0;
            elem = document.getElementById("out");
            elem.innerHTML = Array.isArray(data) ? JSON.stringify(prepareData, {}, 2) : _prettyPrintJson.prettyPrintJson.toHtml(prepareData, {
              quoteKeys: true,
              indent: 2
            });
...
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","core-js/stable":"node_modules/core-js/stable/index.js","axios":"node_modules/axios/index.js","pretty-print-json":"node_modules/pretty-print-json/dist/pretty-print-json.js"}],"src/index.js":[function(require,module,exports) {
// Please run your solution from this file
var _require = require("./solution"),
    renderData = _require.renderData,
    prepareData = _require.prepareData;

renderData(prepareData);
console.log("Hello from %csrc/index.js", "font-weight:bold");
},{"./solution":"src/solution.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
